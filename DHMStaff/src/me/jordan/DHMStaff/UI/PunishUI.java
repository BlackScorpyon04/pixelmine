...
public class PunishUI {
	...
	public static void initialize() {
		name = Utils.color(Main.plugin.getConfig().getString("prefix") + " " +"&cPunish GUI");
	...
	public static Inventory GUI(Player p, String plrname) {
		...
		Utils.createItemByte(inv, Material.RAW_FISH.toString(), 3, 1, 15, "&cDisrespect", "&7Rule #6", "&7E.G \"You suck!\", \"Fuck you retard!\"");
